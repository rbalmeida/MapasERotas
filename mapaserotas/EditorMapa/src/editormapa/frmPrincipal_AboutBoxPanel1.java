...
public class frmPrincipal_AboutBoxPanel1 extends JPanel {
    ...
    public frmPrincipal_AboutBoxPanel1() {
        try {
            jbInit();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jbInit() throws Exception {
        ...
        labelTitle.setText("Mapas e Rotas");
        labelAuthor.setText("Rafael - Taigo - Wellington");
        labelCopyright.setText("2007 - 4ACPN");
        labelCompany.setText("Universidade São Judas Tadeu");
